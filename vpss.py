...
async def post_init(application: Application) -> None:
    ...
    # Admin commands are registered as handlers below and protected by admin checks.
    # Do not register a chat-scoped command menu here; some Telegram API versions
    # reject the scoped command payload with BadRequest (e.g. Frozen_set_invalid).
